...
import Termo.Estilo;
import Termo.KeyHandler;
import Termo.PalavraGerenciador;
...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private int linha = 1;
    private final PalavraGerenciador palavraManager = new PalavraGerenciador();
    private final KeyHandler keyH = new KeyHandler(palavraManager);
    ...
    public TelaPrincipal() {
        ...
        Estilo estilo = new Estilo(matrixJLabel, matrixJPanel);        
        ProcessadorPalavra pp = new ProcessadorPalavra(estilo);
        pp.iniciarNovoJogo(jLabelUltimaPalavra);
        estilo.setCorTexto(Color.white);
    }
    
    private void initMatrix() {
        JPanel[][] matrixJPanel = new JPanel[][] {
    ...
    private void initComponents() {
        ...
        jLabelUltimaPalavra = new javax.swing.JLabel();
        ...
        jLabel21.setText("Ultima palavra:");

        jLabelUltimaPalavra.setForeground(new java.awt.Color(255, 255, 255));
        jLabelUltimaPalavra.setText("-----");
            ...
            .addGroup(jPanelBackgroundLayout.createSequentialGroup()
                .addGroup(jPanelBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelBackgroundLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabelUltimaPalavra)))
    ...
    private javax.swing.JLabel jLabelUltimaPalavra;
